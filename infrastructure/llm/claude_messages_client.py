...
class ClaudeMessagesVisionClient(LlmVisionClient):
    ...
    def _sanitize_schema(schema: dict[str, Any]) -> dict[str, Any]:
        """
        Anthropic tool_use acepta JSON Schema pero conviene eliminar
        claves que generan ruido/errores ('title', '$defs' se mantiene
        porque lo usan $ref). Pydantic v2 ya produce schemas válidos.
        """
